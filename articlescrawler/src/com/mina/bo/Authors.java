...
@NamedQueries({
    ...
    , @NamedQuery(name = "Authors.findBySlug", query = "SELECT a FROM Authors a WHERE a.slug = :slug")
    , @NamedQuery(name = "Authors.findByCount", query = "SELECT a FROM Authors a WHERE a.count = :count")})
public class Authors implements Serializable {
    ...
    public String toString() {
        return "com.mina.bo.Authors[ id=" + id + " ]";
    }
